...
To access information using \code{*GET} and \code{*VGET}, storing directly to NumPy arrays:
\begin{lstlisting}[language=Python]
...
To store the finite element mesh as a VTK \textt{UnstructuredGrid} data object:
\begin{lstlisting}[language=Python]

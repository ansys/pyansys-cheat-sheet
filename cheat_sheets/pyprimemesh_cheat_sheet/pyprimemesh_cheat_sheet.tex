...
\begin{center}
Getting Started with PyPrimeMesh \includegraphics[height=\fontcharht\font`\S]{slash.png} \href{https://github.com/ansys/pyprimemesh}{\color{blue}{PyAnsys on GitHub}} \includegraphics[height=\fontcharht\font`\S]{slash.png} Visit \code{\href{https://prime.docs.pyansys.com/}}{\color{blue}{prime.docs.pyansys.com}}
\end{center}
\end{document}

...
pymapdl_cheat_sheet:
	...
	(test -f $(BUILDDIR)/pymapdl_cheat_sheet.pdf && echo pdf exists) || exit 1
...
pyaedt_API_cheat_sheet:
	...
	(test -f $(BUILDDIR)/pyfluent_cheat_sheet.pdf && echo pdf exists) || exit 1
...
pyedb_API_cheat_sheet:
	...
	(test -f $(BUILDDIR)/pyedb_API_cheat_sheet.pdf && echo pdf exists) || exit 1
...
pyprimemesh_cheat_sheet:
	...
	(test -f $(BUILDDIR)/pyprimemesh_cheat_sheet.pdf && echo pdf exists) || exit 1
...
pydpf-core_cheat_sheet:
	...
	(test -f $(BUILDDIR)/pydpf-core_cheat_sheet.pdf && echo pdf exists) || exit 1

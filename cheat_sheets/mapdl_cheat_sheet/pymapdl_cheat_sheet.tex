...
\begin{center}
Getting Started with PyMAPDL \includegraphics[height=\fontcharht\font`\S]{slash.png} \href{https://github.com/pyansys/pymapdl}{{\color{blue}PyMAPDL on GitHub}} \includegraphics[height=\fontcharht\font`\S]{slash.png} Visit \code{\href{https://mapdl.docs.pyansys.com/}{{\color{blue}mapdl.docs.pyansys.com}}}
\end{center}
\end{document}
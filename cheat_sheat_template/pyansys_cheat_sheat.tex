...
% Add the title of cheat sheat here
% ----------------------------------------
...
% Add Subsection
% This session includes the useful links to the docummentation of library
% example: installation, Api reference, commands, examples.
% Replace the name of link in 'name of link'

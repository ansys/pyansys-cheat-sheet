...
\AddToShipoutPicture*
	{\put(670,560){\includegraphics[height = 1.25cm]{ansys.png}}}
...
\vfill
\section{\includegraphics[height=\fontcharht\font`\S]{slash.png} MAPDL Math Class}
\vfill
\subsection{References}
\begin{itemize}
\item \href{https://dev.mapdldocs.pyansys.com/getting_started/index.html}{Getting Started}
\item \href{https://dev.mapdldocs.pyansys.com/mapdl_commands/index.html}{MAPDL Commands}
\item \href{https://dev.mapdldocs.pyansys.com/api/index.html}{API Reference}
\end{itemize}

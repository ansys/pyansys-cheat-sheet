...
\begin{center}
Getting Started with PyDPF-Post \includegraphics[height=\fontcharht\font`\S]{slash.png} \href{https://github.com/ansys/pydpf-post}{{\color{blue}PyDPF-Post on GitHub}} \includegraphics[height=\fontcharht\font`\S]{slash.png} Visit \code{\href{https://post.docs.pyansys.com/version/stable/}}{{\color{blue}post.docs.pyansys.com}}
\end{center}
\end{document}